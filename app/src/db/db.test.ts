...
describe('FrazodromDB — schema v5 (PLAN.md §5.3/§7.5/§8.5/§8.9)', () => {
  it('declares every table from §5.3 plus judgeDisputes (§7.5), tutorActionCache (§8.5), and freeTalkSessions (§8.9)', () => {
