...
- [x] Manual inventory status after this pass: 439 checklist items; 199 checked, 230 open, 4 blocked, 6 N/A.
- [x] `npm run lint` — exit code 0.
- [x] `npm run typecheck` — exit code 0.
- [x] `npm run test` — 47 files, 411 tests passed.
- [x] `npm run build` — exit code 0; production preview получает свежий build через Playwright webServer.
- [x] `npm run e2e` — 131/131 passed: Chromium, Firefox, WebKit, Edge, mobile Chromium, mobile WebKit.
...
- [x] `npm run verify` — exit code 0; 411 unit tests and 131 E2E tests, full order lint → typecheck → unit → build → E2E.
...
- [x] Full `npm run verify` after backup work: 411 unit + 131 E2E passed across all six projects.
