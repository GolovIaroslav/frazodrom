...
- [x] Manual inventory status as of 2026-07-18: 449 checklist items; 408 checked, 33 open, 2 blocked, 6 N/A.
...
- Auto-play probe: the correct-answer status appeared, but with Gemini/Kokoro speech disabled no `speechSynthesis.speak` call occurred; automatic flows intentionally disable local fallback, so this item remains open.
